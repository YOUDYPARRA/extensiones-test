...
function sendMessage() {
  chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
    lastTabId = tabs[0].id;
    console.log("menssaje enviado");
    chrome.tabs.sendMessage(lastTabId, "PAGINA BACKGROUND ENVIADA.");
  });
}
...
chrome.runtime.onSuspend.addListener(function() {
  ...
  chrome.tabs.sendMessage(lastTabId, "PAGINA BACKGROUN NO CARGADA");
});
